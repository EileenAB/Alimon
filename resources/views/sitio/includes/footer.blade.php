...
<div class="row">
    <div class="col">
        ...
        <strong>
            <a
                style="color: rgb(53, 177, 42)"
                target="_blank"
                href="https://www.instagram.com/shadow._corporation/"
                >Shadow Corporation
            </a>
        </strong>
    </div>
        ...
        <div class="col-xs-12 col-md-6 col-lg-4 text-center">
            ...
            <div class="mb-2">
                ...
                <a class="text-white text-decoration-none" href="#"
                    >empresa.alimon@alimon.com</a
                >
            </div>
            <div class="mb-2">
                <i class="fa-solid fa-phone-flip fa-lg text-center"></i>
                <a class="text-white text-decoration-none" href="#"
                    >271-217-5751</a
                >
            </div>
            ...
            <div class="mb-2">
                ...
                <a class="text-white text-decoration-none" href="#">
                    <a href="">
                        ...
                        >
                            <path
                                d="M40.0001 20.1226C40.0001 9.00756 31.0451 -0.00244141 20.0001 
                            -0.00244141C8.95012 5.85939e-05 -0.00488281 9.00756 -0.00488281
                             20.1251C-0.00488281 30.1676 7.31012 38.4926 16.8701 40.0026V25.9401H11.7951V20.1251H16.8751V15.6876C16.8751 10.6451
                              19.8626 7.86006 24.4301 7.86006C26.6201 7.86006 28.9076 8.25256 28.9076 8.25256V13.2026H26.3851C23.9026 13.2026
                               23.1276 14.7551 23.1276 16.3476V20.1226H28.6726L27.7876 25.9376H23.1251V40.0001C32.6851 38.4901 40.0001 30.1651 
                               40.0001 20.1226Z"
                                fill="white"
                            />
                        </svg> </a
                    ><strong> <span>Facebook</span></strong></a
                >
            </div>
            <div class="mb-2">
                ...
                <a class="text-white text-decoration-none" href="#"
                    ...
                    ></a>
                    <strong> <span>Instagram</span></strong></a
                >
            </div>
        </div>
